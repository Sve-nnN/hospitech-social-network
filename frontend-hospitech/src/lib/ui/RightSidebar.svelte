	...
	<div>
		...
		<div class="space-y-2">
			{#each suggestedHotels as hotel}
				...
				>
					<div
						class="w-9 h-9 bg-gray-200 rounded-lg flex items-center justify-center text-gray-600 font-semibold text-sm flex-shrink-0"
					>
						{hotel.name[0]}
					</div>
					...
					<button
						class="text-primary-600 hover:bg-primary-50 px-3 py-1 rounded-md text-sm font-medium transition-colors"
					>
						Follow
					</button>
				</div>
